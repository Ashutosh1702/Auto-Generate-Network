...
import { FiCheck, FiArrowRight, FiAward, FiCalendar, FiSmartphone, FiWifi, FiBattery } from 'react-icons/fi'
...
const WebsiteSolutions = () => {
    ...
    <div className="flex-grow flex flex-col bg-slate-50 text-slate-800 font-sans select-none h-full">
      ...
      <div className="h-10 border-b border-slate-200/80 flex items-center justify-between px-4 bg-white shrink-0">
        <div className="flex items-center space-x-1.5">
          <div className="w-5 h-5 rounded bg-blue-600 flex items-center justify-center text-white text-[10px] font-black">E</div>
          <span className="text-blue-600 font-black text-xs tracking-tight">Elite Garage</span>
        </div>
      ...
      <div className="flex-grow p-4 md:p-6 flex flex-col justify-between overflow-y-auto">
        <div className="grid grid-cols-2 gap-4 items-center">
          <div className="space-y-2.5">
            ...
            <p className="text-[7.5px] md:text-[8px] text-slate-500 font-medium leading-relaxed">
              Dealer-level diagnostics, certified technicians, and full warranty protection.
            </p>
          ...
          <div className="flex justify-center items-center relative h-full min-h-[90px]">
            ...
            <svg viewBox="0 0 120 60" className="w-full h-auto text-blue-600 max-h-[80px]" fill="currentColor">
              <defs>
              ...
              <path d="M10 40 L18 26 C22 24, 30 20, 42 20 C54 20, 64 16, 74 20 L96 26 L112 36 Q116 38, 116 42 L116 46 L98 46 Q98 40, 92 40 Q86 40, 86 46 L34 46 Q34 40, 28 40 Q22 40, 22 46 L10 46 Z" fill="url(#car-grad)" opacity="0.9" />
              <path d="M30 23 L44 23 L44 32 L27 32 Z" fill="#ffffff" opacity="0.8" />
              <path d="M48 23 L68 23 L72 32 L48 32 Z" fill="#ffffff" opacity="0.8" />
              <path d="M72 23 L86 28 L82 32 L72 32 Z" fill="#ffffff" opacity="0.8" />
        ...
        <div className="mt-4 border-t border-slate-100 pt-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-[7.5px] font-black text-slate-800 tracking-wider uppercase">Services</span>
          ...
          <div className="grid grid-cols-3 gap-2.5">
            {[
              { title: "MOT Testing", price: "£45.00", desc: "DVSA certified bays", icon: "🚗" },
              { title: "Car Servicing", price: "£89.00", desc: "Interim & major checks", icon: "🔧" },
              { title: "Tyres & Tracking", price: "£55.00", desc: "Fitted while you wait", icon: "⚙️" }
            ].map((s, i) => (
              <div 
                key={i} 
              ...
              >
                <div>
                  ...
                  <div className="text-[7.5px] font-extrabold text-slate-900 leading-tight">{s.title}</div>
                  <div className="text-[6px] text-slate-400 font-medium leading-normal mt-0.5">{s.desc}</div>
                </div>
                <div className="text-[7.5px] font-black text-blue-600 mt-1.5">{s.price}</div>
              </div>
            ))}
          </div>
        </div>
  ...
  const renderBookingPage = () => {
    const services = [
      { id: "mot", name: "MOT Test Only", price: "£45.00", time: "45 mins", icon: "🚗" },
      { id: "service", name: "MOT & Interim Service", price: "£139.00", time: "2 hours", icon: "🔧" },
      { id: "full", name: "Full Service Only", price: "£110.00", time: "1.5 hours", icon: "⚙️" }
    ];
      ...
      <div className="flex-grow flex flex-col bg-slate-50 text-slate-800 font-sans select-none h-full overflow-hidden">
        ...
        <div className="h-10 border-b border-slate-200/80 flex items-center justify-between px-4 bg-white shrink-0">
          ...
          <div className="flex items-center space-x-2 text-[6.5px] font-extrabold text-slate-400">
            <span className={bookingStep === 0 ? "text-blue-600 font-black" : bookingStep > 0 ? "text-green-600" : ""}>1. Service</span>
            <span>&gt;</span>
            <span className={bookingStep === 1 ? "text-blue-600 font-black" : bookingStep > 1 ? "text-green-600" : ""}>2. Schedule</span>
            <span>&gt;</span>
            <span className={bookingStep === 2 ? "text-green-600 font-black" : ""}>3. Success</span>
          </div>
        </div>
        ...
        <div className="flex-grow p-4 md:p-5 flex flex-col justify-between overflow-y-auto">
          {bookingStep === 0 && (
            ...
            >
              <div>
                <h2 className="text-[8px] font-black uppercase tracking-wider text-slate-400 mb-1">Step 1</h2>
                <h3 className="text-xs md:text-sm font-black text-slate-900 leading-tight">Select Your Service Option</h3>
                <p className="text-[7px] md:text-[8px] text-slate-500 font-medium">Click on a service below to configure your booking.</p>
              </div>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="leading-tight">
                        <div className="text-[8px] font-black text-slate-900 group-hover:text-blue-600 transition-colors">{s.name}</div>
                        <div className="text-[6.5px] text-slate-400 font-semibold">{s.time} duration</div>
                      </div>
                    </div>
          ...
          {bookingStep === 1 && (
            ...
            >
              <div>
                <h2 className="text-[8px] font-black uppercase tracking-wider text-slate-400 mb-1">Step 2</h2>
                <h3 className="text-xs md:text-sm font-black text-slate-900 leading-tight">Choose Slot & Enter Registration</h3>
              </div>

              <div className="space-y-3">
                <div className="space-y-1">
                  <span className="text-[7.5px] font-extrabold text-slate-500 block">VEHICLE REGISTRATION:</span>
                  <div className="flex justify-center">
                    <div className="bg-amber-400 border-[2px] border-slate-950 rounded-md px-3 py-1 flex items-center shadow-sm relative overflow-hidden h-9 w-[180px]">
                      ...
                      <input
                        type="text"
                        value={bookingReg}
                        onChange={(e) => setBookingReg(e.target.value.toUpperCase())}
                ...
                <div className="space-y-1">
                  <span className="text-[7.5px] font-extrabold text-slate-500 block">SELECT AN APPOINTMENT TIME:</span>
          ...
          {bookingStep === 2 && (
            ...
            >
              <div className="my-auto space-y-3 flex flex-col items-center">
                ...
                <div className="space-y-1">
                  <h3 className="text-xs font-black text-slate-900 leading-none">Booking Confirmed!</h3>
                ...
                <div className="bg-white p-2.5 rounded-xl border border-slate-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.01)] text-[7.5px] text-slate-600 w-full max-w-[220px] text-left space-y-1 font-semibold leading-relaxed">
                  <div>
                    <span className="text-slate-400 block font-medium text-[6.5px]">SERVICE TYPE:</span>
                    <span className="text-slate-900 font-black">{bookingService}</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2 pt-1 border-t border-slate-100 mt-1">
                    <div>
                      <span className="text-slate-400 block font-medium text-[6.5px]">DATE & TIME:</span>
                      <span className="text-slate-900 font-black text-[7px]">{bookingTime.split(" - ")[0]}</span>
                      <span className="text-blue-600 font-black block text-[7px]">{bookingTime.split(" - ")[1]}</span>
                    </div>
                    <div>
                      <span className="text-slate-400 block font-medium text-[6.5px]">LICENCE REG:</span>
    ...
    <div className="flex-grow flex flex-col bg-slate-50 text-slate-800 font-sans select-none h-full overflow-hidden">
      ...
      <div className="h-9 border-b border-slate-200/80 flex items-center justify-between px-3 bg-white shrink-0">
        <div className="flex items-center space-x-1">
          <div className="w-4 h-4 rounded bg-blue-600 flex items-center justify-center text-white text-[8px] font-black">E</div>
          <span className="text-blue-600 font-black text-[9px] tracking-tight">Elite</span>
        </div>
      ...
      <div className="flex-grow p-3 flex flex-col justify-between overflow-y-auto space-y-3">
        ...
        <div className="space-y-1 text-center">
          ...
          <p className="text-[6px] text-slate-400 font-medium leading-normal max-w-[180px] mx-auto">
            Book MOTs, track diagnostic logs, and receive text status updates on your mobile.
          </p>
        </div>
        ...
        <div className="bg-white p-2 rounded-xl border border-slate-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.01)] text-[7px] text-slate-600 space-y-1.5 font-semibold">
          ...
          <div className="flex items-center space-x-2 bg-slate-50 p-1 rounded-lg border border-slate-100">
            ...
            <div>
              <div className="text-[7px] font-black text-slate-900 leading-none">Audi A3 MOT Scan</div>
              <span className="text-[5.5px] text-slate-400 font-medium">Complete: Brake replacement required</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-1.5 pt-2 border-t border-slate-100">
          ...
          <div className="space-y-1">
            {[
              ...
              <div key={i} className="flex justify-between items-center bg-white border border-slate-200/50 p-1.5 rounded-lg text-[6.5px] font-extrabold text-slate-900">
                <span>{s.name}</span>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 md:order-1 space-y-8">
              ...
              {features.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <h3 className={`text-xl font-bold transition-all mb-1 ${isActive ? "text-blue-400" : "text-white"}`}>
                        {item.title}
                      </h3>
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-bold px-8 py-4 rounded-xl shadow-[0_0_20px_rgba(37,99,235,0.3)] transition-all cursor-pointer"
            >
